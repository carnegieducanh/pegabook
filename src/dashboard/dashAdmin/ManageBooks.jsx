...
const ManageBooks = () => {
  ...
  return (
    <div className="my-12 px-4">
      <h2 className="mb-8 font-title text-3xl font-bold">Manage Your Books</h2>
          ...
          <Table.Body className="divide-y" key={book._id}>
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell className="w-1/6 font-medium text-gray-900 dark:text-white">
                <div className="line-clamp-2">{book.bookTitle}</div>
              </Table.Cell>
              <Table.Cell>
                <div className="h-14 w-10 shrink-0 rounded-sm object-cover">
                  <img
                    src={book.imageUrl}
                    alt=""
              ...
              <Table.Cell>
                <div className="mx-auto my-auto flex">
                  <button
                    ...
                    className="rounded-sm bg-red-600 px-4 py-1 font-semibold text-white"
                  >
                    <RiDeleteBinLine />
                  </button>
                </div>
