    ...
    return (
        <div className="px-4 lg:px-24 text-center my-16">
            ...
            <p className=" text-gray-700 text-lg pt-2">
                Chúng tôi tổ chức các sự kiện, hội thảo và nhóm đọc sách để tạo
                cơ hội cho thành viên chia sẻ ý kiến, gặp gỡ những người đam mê
                sách và tạo ra một cộng đồng đọc sách mạnh mẽ.
            </p>
