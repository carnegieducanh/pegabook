...
const SearchMembers = () => {
    ...
    const handleMemberSelect = (member) => {
        ...
        document.getElementById("searchInput").value = member.memberName;

        // Cập nhật giá trị của tên người mượn
        document.getElementById("borrowedBy").value = member.memberName;

        // Cập nhật giá trị của Member ID
        document.getElementById("borrowerID").value = member.memberID;
