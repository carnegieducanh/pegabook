...
const ViewsBook = ({ headline }) => {
  ...
  return (
    <div className="px-4 py-8 text-center lg:px-24">
      <p className="text-xl text-brand"></p>
      <h2 className="my-2 text-left font-title text-4xl font-bold text-black dark:text-linen">
        {headline}
      </h2>
            ...
            {booksData.map((book) => (
              <SwiperSlide key={book._id}>
                <Link to={`/book/${book._id}`}>
                  <div
                    data-aos="zoom-in"
                    className="group flex flex-col gap-4 bg-white pb-2 dark:bg-void lg:w-52"
                  >
